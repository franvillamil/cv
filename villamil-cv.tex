...
\item Memories at War: How the Legacies of Violence Persist or Disappear. \textbf{(Book manuscript)}
...
\textbf{2025} & EPSA (Madrid, ES) [\textit{scheduled}], ESOC Conference (Taipei, TW) [\textit{scheduled}] \\
\textbf{2024} & NEPS Peace Science (Dublin, IE) \\
\textbf{2023} & NEPS Peace Science (Bologna, IT) \\
\textbf{2022} & APSA (Montreal, CA), CES (Lisbon, PT), NEPS Peace Science (London, UK) \\
\textbf{2021} & NEPS Peace Science (online) \\
\textbf{2019} & NEPS Peace Science (The Hague, NL) \\
\textbf{2018} & APSA (Boston, US), NEPS Peace Science (Verona, IT) \\
\textbf{2017} & APSA (San Francisco, US), EPSA (Milan, IT) \\
\end{tabular}
