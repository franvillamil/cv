...
% \begin{itemize}[noitemsep,topsep=-10pt]
% 	\renewcommand\labelitemi{{\boldmath$\cdot$}}
%   \item {\small Media/outreach: \href{https://jop.blogs.uni-hamburg.de/the-impact-of-distant-wars-on-nationalism-lessons-from-spain/}{The JOP Blog}}
% \end{itemize}
...
\begin{itemize}[leftmargin=12pt, itemsep=0pt]
	...
	\item `Determinants of violence during the Spanish Civil War and its long-term consequences.' Spanish Ministry of the Presidency, 10,000€ (PI: Paloma Aguilar), 2023.
	\item `Determinants of violence during the Spanish Civil War and its long-term consequences.' Spanish Ministry of the Presidency, 10,000€ (PI: Paloma Aguilar), 2022.
	\item `Institutional legacies of violent conflict.' UNU-WIDER, \$10,000 (PI: Laia Balcells), 2022.
\end{itemize}
