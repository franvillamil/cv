...
% \textbf{2022}
% \end{minipage}\hfill\begin{minipage}[t]{0.9\textwidth}
% CES International Conference of Europeanists, Lisbon. \textit{(scheduled)}
% \end{minipage}\\
\begin{minipage}[t]{0.1\textwidth}
\textbf{2021}
\end{minipage}\hfill\begin{minipage}[t]{0.9\textwidth}
...
%
% Coordinator of BA Theses for International Studies and Political Science, Department of Social Sciences (2022--)

\subsection*{Referee:}

Journal of Politics, British Journal of Political Science, Comparative Political Studies, Journal of Conflict Resolution, Journal of Peace Research, Political Geography, Review of International Organizations, Civil Wars, Economics of Transition, Defence and Peace Economics, Memory Studies.
