...
\textbf{2026} & SPSA (Zurich), ASN (New York), NEPS (Berlin) \textit{(scheduled)} \\
...
\begin{tabular}{lp{15cm}}
\textbf{2026} & IPERG Seminar, UB (Barcelona); Economic Analysis Seminar, UPO (Sevilla); Getting to Peace without the Peace Makers Workshop, IBEI (Barcelona) \\
