...
\item Balcells, Laia and \textbf{Francisco Villamil} (2026) \href{https://doi.org/10.1017/S1475676526101042}{Generational legacies of authoritarianism: Evidence from Spain}. \textit{European Journal of Political Research}, published online.
...
\item \textbf{Book manuscript:} ``Memories at War: How the Legacies of Violence Persist or Disappear.'' \textit{Under review.}
...
\item Past conflict, media, and polarization in Spain (with Laia Balcells and Juan F. Tellez). \textit{R\&R.}
\item Grassroots human rights: The consequences of mass grave exhumations (with Paloma Aguilar, Fernando de la Cuesta, and Abdelkarim Laglil).
\item Understanding the backlash over Transitional Justice (with Lesley Ann-Daniels).
...
MSCA Doctoral Network DIViNE (Democratic Institutions and Violence Network in Europe), Horizon Europe, 3,085,194 € (with Milan, Essex, Amsterdam, and Uppsala; PI of Madrid node).\\\vspace{-8pt}
\end{minipage}
\begin{minipage}[t]{0.1\textwidth}
\textbf{2024}
\end{minipage}\hfill\begin{minipage}[t]{0.9\textwidth}
...
\href{https://franvillamil.github.io/AQM2/}{Applied Quantitative Methods II} (MA in Social Sciences)\\\vspace{-8pt}
\end{minipage}\hfill\begin{minipage}[t]{0.12\textwidth}
\flushright\textbf{2026--}
\end{minipage}
\begin{minipage}[t]{0.85\textwidth}
\href{https://franvillamil.github.io/res_design/}{Research Design} (MA in Computational Social Sciences)\\\vspace{-8pt}
\end{minipage}\hfill\begin{minipage}[t]{0.12\textwidth}
\flushright\textbf{2022--}
\end{minipage}
\begin{minipage}[t]{0.85\textwidth}
\href{https://raw.githack.com/franvillamil/syllabi/master/current/syllabus_IR.pdf}{International Relations} (MA in Social Sciences)\\\vspace{-8pt}
\end{minipage}\hfill\begin{minipage}[t]{0.12\textwidth}
\flushright\textbf{2022--2025}
\end{minipage}

% \vspace{-10pt}
\subsection*{Undergraduate (UC3M)}

\begin{minipage}[t]{0.85\textwidth}
\href{https://franvillamil.github.io/pol_mundial/}{Política Mundial}\\\vspace{-8pt}
\end{minipage}\hfill\begin{minipage}[t]{0.12\textwidth}
\flushright\textbf{2026--}
\end{minipage}
\begin{minipage}[t]{0.85\textwidth}
\href{https://franvillamil.github.io/wp_polvio/}{War, Peace, and Political Violence}\\\vspace{-8pt}
\end{minipage}\hfill\begin{minipage}[t]{0.12\textwidth}
\flushright\textbf{2020--2025}
\end{minipage}
\begin{minipage}[t]{0.85\textwidth}
Multidisciplinary seminar on International Studies\\\vspace{-8pt}
\end{minipage}\hfill\begin{minipage}[t]{0.12\textwidth}
\flushright\textbf{2020--2021}
\end{minipage}
\begin{minipage}[t]{0.85\textwidth}
Security, peace, and conflict resolution\\\vspace{-8pt}
\end{minipage}\hfill\begin{minipage}[t]{0.12\textwidth}
\flushright\textbf{2020}
\end{minipage}
...
\begin{itemize}[leftmargin=*, nolistsep]
	\item Margherita Salvia (PhD external examiner, University of Genova, 2026).
\end{itemize}

\subsection*{MA theses}

% \textbf{2026}: Evangelia Skourti, Tone Varberg, David Valero, Carlos Morán; Noah Fürup.
...
\textbf{2026} & SPSA (Zurich), ASN (New York) \textit{[scheduled]}, NEPS (Berlin) \textit{(scheduled)} \\
...
\begin{tabular}{lp{15cm}}
\textbf{2026} & IPERG Seminar, UB (Barcelona); Economic Analysis Seminar, UPO (Sevilla); Getting to Peace without the Peace Makers Worlshop, IBEI (Barcelona) \textit{(scheduled)} \\
\textbf{2025} & García-Pelayo Seminar, CEPC (Madrid), ICP Seminar, PUC Chile (Santiago); Empirical Studies of Conflict, ESOC (Taipei) \\
\textbf{2024} & IC3JM Conference (Madrid); GEINK, UPV/EHU (Bilbao); MESS (Madrid) \\
\textbf{2023} & SPARC Seminar, Institute of Social Sciences (Lisbon); STNAMES Lab (online) \\
...
\begin{itemize}[leftmargin=*, nolistsep]
  \item Bachelor theses coordinator, International Studies and Political Science, UC3M (2022--).
	...
	\item Organizer, internal seminar, Juan March Institute, UC3M (2021--2023)
\end{itemize}

\subsection*{Profession}

\begin{itemize}[leftmargin=*, nolistsep]
	\item Co-organizer, Junior Workshop in Historical Political Economy (Madrid, June 2025)
	\item Reviewer: \textit{American Political Science Review, The Journal of Politics, Nature Human Behaviour, British Journal of Political Science, Comparative Political Studies, World Politics, Journal of Conflict Resolution, Journal of Peace Research, International Studies Quarterly, Political Science Research and Methods, Journal of European Public Policy, European Political Science Review, Political Behavior, Political Geography, Review of International Organizations, Civil Wars, Economics of Transition, Defence and Peace Economics, International Journal of Human Rights, Journal of Human Rights, Memory Studies, Social Movement Studies, Nationalities Papers, Humanities and Social Sciences Communications, Sociology Lens}, German Research Foundation.
	% \item \textit{Grant reviewer:} German Research Foundation (Deutsche Forschungsgemeinschaft)
\end{itemize}
