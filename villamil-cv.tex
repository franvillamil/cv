...
\begin{minipage}[t]{0.9\textwidth}
  PhD Political Science, \textit{ETH Zurich}
	...
	\begin{itemize}[leftmargin=18pt]\small
	  ...
	  \item Juan Linz Price to the Best Doctoral Dissertation in Political Science (CEPC, Spain)
	\end{itemize}
\end{minipage}
...
\begin{minipage}[t]{0.82\textwidth}
  ...
  Visiting Scholar, \textit{Carlos III-Juan March Institute}, Madrid\vspace{2pt}\\
	Short-Term Visiting Researcher, \textit{Georgetown University}, Washington DC\vspace{2pt}\\
	Research intern, Department of Sociology, \textit{Universidad de Salamanca}, Spain
\end{minipage}
...
\item Balcells, Laia, Juan F Tellez, and \textbf{Francisco Villamil} (forthcoming) The wars of others: The effect of the Russian invasion of Ukraine on Spanish nationalism. Conditionally accepted at \textit{The Journal of Politics}.
...
\item The legacies of authoritarian repression on civil society (with Laia Balcells).\\\href{https://doi.org/10.35188/UNU-WIDER/2023/309-3}{WIDER Working Paper 1/2023.} \textit{Under review.}
...
% Workshop on quantitative analyses of street-names data, Universidad Pablo de Olavide, Sevilla (2023);
